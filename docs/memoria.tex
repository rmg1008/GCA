...
centralizada de la configuración de red en los equipos de las aulas.La solución permite la segmentación de los
dispositivos en grupos y la aplicación de restricciones personalizadas para el acceso a recursos internos y externos,
incluyendo Internet.Se busca optimizar el control y administración de la red educativa, mejorando la seguridad y la
eficiencia en la gestión de los permisos de acceso.
\end{abstract}
...
\begin{abstract}
The objective of this project is to develop and implement a web platform and an agent that allows the centralized
management of the network configuration in the classrooms.The solution allows the segmentation of devices into groups
and the application of customized restrictions for access to internal and external resources, including the Internet.
The aim is to optimize the control and administration of the educational network, improving security and efficiency in
